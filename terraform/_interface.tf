...
variable "custom_image_id_westus" {
  type        = "string"
  description = "Azure image ID for custom Packer image (West US)"
}

variable "custom_image_id_eastus" {
  type        = "string"
  description = "Azure image ID for custom Packer image (East US)"
}
